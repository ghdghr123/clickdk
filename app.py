...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "Welcome! I'm a bot for website click & stats monitoring.\n\n"
        "Press the button below to open the dashboard:",
...
async def clear(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    conn.commit()
    conn.close()
    await update.message.reply_text("All statistics have been cleared.")
